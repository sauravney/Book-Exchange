...
// Array of some random book cover image URLs
const randomCoverUrls = [
  "https://images.unsplash.com/photo-1544947950-fa07a98d237f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cmFuZG9tJTIwYm9va3xlbnwwfHwwfHwwfDA&auto=format&fit=crop&w=500&q=60",
  "https://images.unsplash.com/photo-1544947950-fa07a98d237f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cmFuZG9tJTIwYm9va3xlbnwwfHwwfHwwfDA&auto=format&fit=crop&w=500&q=60",
  "https://images.unsplash.com/photo-1544947950-fa07a98d237f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cmFuZG9tJTIwYm9va3xlbnwwfHwwfHwwfDA&auto=format&fit=crop&w=500&q=60",
  "https://images.unsplash.com/photo-1544947950-fa07a98d237f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cmFuZG9tJTIwYm9va3xlbnwwfHwwfHwwfDA&auto=format&fit=crop&w=500&q=60",
  "https://images.unsplash.com/photo-1544947950-fa07a98d237f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cmFuZG9tJTIwYm9va3xlbnwwfHwwfHwwfDA&auto=format&fit=crop&w=500&q=60",
...
const getRandomCoverUrl = () => {
  return randomCoverUrls[Math.floor(Math.random() * randomCoverUrls.length)];
};
...
const BrowsePage = () => {
    ...
    const fetchBooks = async () => {
      try {
        ...
        if (Array.isArray(data)) {
          // Add a random cover URL to each book
  ...
  const handleDeleteBook = async (bookId: string) => {
    try {
      await axios.delete(
        `https://bookhubb-jnsr.onrender.com/api/books/${bookId}`
      );
