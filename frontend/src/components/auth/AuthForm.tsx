...
const API_BASE_URL = "https://bookhubb-jnsr.onrender.com";
...
export function AuthForm() {
  ...
  return (
    <Card className="w-full max-w-md mx-auto text-left shadow-lg bg-gray-50">
      <CardHeader>
      ...
      <CardContent>
        {isLogin ? (
          ...
          >
            ...
            <Button
              type="submit"
              className=" w-full bg-purple-600 hover:bg-purple-700 text-white text-base px-6 py-2.5 rounded-lg shadow transition-all gap-2"
